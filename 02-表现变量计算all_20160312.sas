...
where trddt >= '01jan2010'd;
drop Adjprcnd Adjprcwd Dretnd Dretwd;
run;

data fmt;
set daytrd_all_2010_2015(obs=1);
run;
...
quit;
data daytrd_all_2010_2015;
        set daytrd_all_2010_2015(rename=(&renames.));
run;

proc contents data=daytrd_all_2010_2015 out=name1(keep=name label) noprint;run;
